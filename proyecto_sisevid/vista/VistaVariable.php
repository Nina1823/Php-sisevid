...
include '../control/ControlVariable.php';
...
switch ($boton) {
	case 'Guardar':
		$objVariable = new Variable($id,$nom,$fechaCreacion,$fkEmailUsuario);
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Variables</span></a>
						</div>
					</div>
				</div>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="form1" action="VistaVariable.php" method="post">
					<div class="modal-header">
						<h4 class="modal-titleVariables</h4>
						...
						<div class="form-group">
							<nav>
								<div class="nav nav-tabs" id="nav-tab" role="tablist">
									<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Datos Variable</a>
								</div>
							</nav>
							<div class="tab-content" id="nav-tabContent">
								<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
									...
									<div class="form-group">
										<label>nom</label>
										<input type="text" class="form-control" name="txtNom" value="<?php echo $nom ?>">
									</div>

                                    <div class="form-group">
										<label>Fecha creación</label>
										<input type="datetime-local" class="form-control" name="txtFechaCreacion" value="<?php echo $fechaCreacion ?>">
									</div>

                                    <div class="form-group">
										<label>Email usuario</label>
										<input type="text" class="form-control" name="txtfkEmailUsuario" value="<?php echo $fkEmailUsuario ?>">
									</div>
									<div class="form-group">
