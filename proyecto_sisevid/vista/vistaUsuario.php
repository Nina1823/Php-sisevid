	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Gestión <b>Usuario</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestión de Usuario</span></a>		
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Tipo Identificador</span></a>								
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					<?php for($i=0;$i<count($arregloUsuarios);$i++){?>
					<tr>
						<td>
							<span class="custom-checkbox">
						...
						<td><?php echo $arregloUsuarios[$i]->getNomUsuario(); ?></td>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="form1" action="vistaUsuario.php" method="post">
					...
					<nav>
						...
						<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="txtNomUsuario" value="<?php echo $nom ?>">
							</div>
							<div class="form-group">
								<label>Contraseña</label>
								<input type="text" class="form-control" name="txtContrasena" value="<?php echo $con ?>">
							</div>
							<div class="form-group">
